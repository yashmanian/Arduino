...
int xzero = 0;                   // the first X value
int yzero = 0;                   // the first Y value
int segs = 20;                   // number of intervals to consider par half direction
double zerohold = 4;             // number of intervals to consider as "zero position" 
